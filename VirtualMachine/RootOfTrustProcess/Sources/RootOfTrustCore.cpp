    ...
    )
{
    ...
    m_oRootOfTrustCoreProperties.SetProperty("DataOwnerAccessToken", oInitializationParameters.GetString("DataOwnerAccessToken"));
    ...
    ::SetIpAddressOfSailWebApiPortalGateway(m_oRootOfTrustCoreProperties.GetProperty("SailWebApiPortalIpAddress"), 8000);
    ...
    ::VirtualMachineStatusUpdate(m_oRootOfTrustCoreProperties.GetProperty("DataOwnerAccessToken"), m_oRootOfTrustCoreProperties.GetProperty("VirtualMachineIdentifier"), "READY");
        ...
        try
        {
            ...
            if ((true == fIsShuttingDown)||(30000 < un64ElapsedTimeInMilliseconds))
            {
                ...
                if ((0 < strEosb.size())&&(0 < strAuditEventQueue.size()))
                {
                    ...
                    fHeartbeatHasBeenSent = ::VirtualMachineStatusUpdate(strEosb, m_oRootOfTrustCoreProperties.GetProperty("VirtualMachineIdentifier"), "IN_USE");
                }

                strEosb = m_oRootOfTrustCoreProperties.GetProperty("DataOwnerAccessToken");
                ...
                if ((0 < strEosb.size())&&(0 < strAuditEventQueue.size()))
                {
                    ...
                    if (false == fHeartbeatHasBeenSent)
                    {
                        ...
                        __DebugAssert(0 < m_oRootOfTrustCoreProperties.GetProperty("VirtualMachineIdentifier").size());
                        __DebugAssert(0 < m_oRootOfTrustCoreProperties.GetProperty("DataOwnerUserIdentifier").size());
                        fHeartbeatHasBeenSent = ::VirtualMachineStatusUpdate(strEosb, m_oRootOfTrustCoreProperties.GetProperty("VirtualMachineIdentifier"), "READY");
                    }
                }
                ...
                if ((0 < strEosb.size())&&(0 < strAuditEventQueue.size()))
                {
                    ...
                    if (false == fHeartbeatHasBeenSent)
                    {
                        ...
                        fHeartbeatHasBeenSent = ::VirtualMachineStatusUpdate(m_oRootOfTrustCoreProperties.GetProperty("VirtualMachineEosb"), m_oRootOfTrustCoreProperties.GetProperty("VirtualMachineIdentifier"), "READY");
                    }
                }
