...
namespace MicrosoftAzureVirtualMachineInitializer
{
    public partial class ExceptionsDialog : Form
    {
            ...
            )
        {
            ...
            do
            {
                string newException = MicrosoftAzureApiPortalInterop.GetNextException();
                ...
                newException = SailWebApiPortalInterop.GetNextException();
                if (0 < newException.Length)
                {
                    // Increate the internal count of exceptions. This is addressed
                    // externally
        ...
        /// </summary>
        /// <returns></returns>
        public uint ExceptionsCount
        {
            get
            {
                return m_ExceptionsCount + MicrosoftAzureApiPortalInterop.GetExceptionCount() + SailWebApiPortalInterop.GetExceptionCount();
            }
        }
