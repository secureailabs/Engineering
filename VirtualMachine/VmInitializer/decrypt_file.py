...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", "--input", dest="encrypted_file", required=True, help="Encrypted file path")
    parser.add_argument("-o", "--output", dest="decrypted_file", required=True, help="Decrypted file path")
    parser.add_argument("-k", "--key", dest="key", required=True, help="Base64 encoded key")
    parser.add_argument("-n", "--nonce", dest="nonce", required=True, help="Base64 encoded nonce")
    parser.add_argument("-t", "--tag", dest="tag", required=True, help="Base64 encoded tag")
