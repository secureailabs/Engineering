...
class DataSetManagementFastApi:
    ...
    def get_all_datasets(self, sail_portal: SailPortalFastApi):
        ...
        try:
            response = requests.get(f"{self.base_url}/datasets", headers=request_headers, verify=False)
    ...
    def register_dataset(self, sail_portal: SailPortalFastApi, payload: Dataset):
        ...
        try:
            ...
            response = requests.post(
                f"{self.base_url}/datasets", verify=False, headers=request_headers, json=json_params
            )
        except requests.exceptions.RequestException as error:
            print(f"\n{error}")
    ...
    def get_dataset_by_id(self, sail_portal: SailPortalFastApi, dataset_id: str):
        ...
        try:
            response = requests.get(f"{self.base_url}/datasets/{dataset_id}", headers=request_headers, verify=False)
        except requests.exceptions.RequestException as error:
            print(f"\n{error}")
    ...
    def update_dataset(self, sail_portal: SailPortalFastApi, dataset_id: str, payload: Dataset):
        """
        Update dataset.\n
        ...
        try:
            ...
            response = requests.put(
                f"{self.base_url}/datasets/{dataset_id}", verify=False, headers=request_headers, json=json_params
            )
        except requests.exceptions.RequestException as error:
            print(f"\n{error}")
    ...
    def delete_dataset_by_id(self, sail_portal: SailPortalFastApi, dataset_id: str):
        ...
        try:
            #  params as json
            response = requests.delete(f"{self.base_url}/datasets/{dataset_id}", verify=False, headers=request_headers)
        except requests.exceptions.RequestException as error:
            print(f"\n{error}")
    ...
    def get_all_dataset_versions(self, sail_portal: SailPortalFastApi, dataset_id: str):
        ...
        try:
            response = requests.get(f"{self.base_url}/dataset-versions?dataset_id={dataset_id}", headers=request_headers, json=json_params, verify=False)
        except requests.exceptions.RequestException as error:
            print(f"\n{error}")
    ...
    def register_dataset_version(self, sail_portal: SailPortalFastApi, payload: DatasetVersion):
        """
        ...
        try:
            #  params as json
            response = requests.post(
                f"{self.base_url}/dataset-versions", verify=False, headers=request_headers, json=json_params
            )
        except requests.exceptions.RequestException as error:
            print(f"\n{error}")
    ...
    def get_dataset_version_by_id(self, sail_portal: SailPortalFastApi, dataset_version_id: str):
        """
        ...
        try:
            response = requests.get(f"{self.base_url}/dataset-versions/{dataset_version_id}", headers=request_headers, verify=False)
        except requests.exceptions.RequestException as error:
            print(f"\n{error}")

        return response, response.json()

    def update_dataset_version(self, sail_portal: SailPortalFastApi, dataset_version_id: str, payload: DatasetVersion):
        """
        ...
        try:
            #  params as json
            response = requests.put(
                f"{self.base_url}/dataset-versions/{dataset_version_id}", verify=False, headers=request_headers, json=json_params
            )
        except requests.exceptions.RequestException as error:
            print(f"\n{error}")
    ...
    def delete_dataset_version_by_id(self, sail_portal: SailPortalFastApi, dataset_version_id: str):
        """
        ...
        try:
            #  params as json
            response = requests.delete(f"{self.base_url}/dataset-versions/{dataset_version_id}", verify=False, headers=request_headers)
        except requests.exceptions.RequestException as error:
            print(f"\n{error}")
