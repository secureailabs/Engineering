...
sudo chown jupyternotebook:jupyternotebook /data
sudo chmod 744 /data

# cd /data || exit
cd /home/jupyternotebook
jupyter notebook --no-browser --ip 0.0.0.0 --port 8888 --NotebookApp.password='argon2:$argon2id$v=19$m=10240,t=10,p=8$CxhdT07OWZQ/VJYTmuT2GA$SFN8uqEKgga19cESOi3jLN5iecshMFPt7BpyHIoL7/g' --NotebookApp.allow_origin='*'
