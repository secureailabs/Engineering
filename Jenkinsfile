        ...
        stage('Git') {
            steps {
                ...
                script {
                    ...
                    docker exec -w /Engineering/Milestone5/ ubuntu_dev_CI sudo mongod --port 27017 --dbpath /srv/mongodb/db0 --replSet rs0 --bind_ip localhost --fork --logpath /var/log/mongod.log
                    docker exec -w /Engineering/Milestone5/ ubuntu_dev_CI ps -ef
                    '''
                }
            }
            post {
