...
bin/Release/net6.0/linux-x64/publish/DatasetTool --email nadams@mghl.com --password SailPassword@123 --config SampleFhir/igr_config.json --ip 172.20.100.10:8000

# Run the dataset tool for IGR dataset
bin/Release/net6.0/linux-x64/publish/DatasetTool --email lbart@igr.com --password SailPassword@123 --config SampleFhir/mghl_config.json --ip 172.20.100.10:8000
