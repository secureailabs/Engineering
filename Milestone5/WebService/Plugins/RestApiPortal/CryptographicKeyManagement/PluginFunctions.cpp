 ...
 * @brief Call CryptographicKeyManagementPlugin's Submit request and return a unique identifier
 ...
 * @brief Call CryptographicKeyManagementPlugin's GetResponse and return response associated
 ...
 *        function. This function creates  singleton object of CryptographicKeyManagementPlugin class and
 *        calls CryptographicKeyManagementPlugin's InitializePlugin, which initializes the plugin's
 *        data members including its dictionary. This function then calls RegisterPluginFn which is used to
 *        register CryptographicKeyManagementPlugin's dictionary with the RestFramework
 ...
 * @brief Call ShutdownCryptographicKeyManagementPlugin to release the object resources and
