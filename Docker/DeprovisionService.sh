...
PrintHelp()
{
    ...
    echo -e "\t-s Service Name: all | devopsconsole | apiservices | webfrontend | newwebfrontend | orchestrator | remotedataconnector | securecomputationnode | rpcrelated | auditserver"
