...
export API_SERVICES_TAG="v0.1.0_f8fbde6"
export API_SERVICES_TAG=$API_SERVICES_TAG
export AUDIT_SERVICES_TAG="v0.1.0_feb6c24a"
export AUDIT_SERVICES_TAG=$AUDIT_SERVICES_TAG
export SCN_TAG="v0.1.0_588d7c90"
export SCN_TAG=$SCN_TAG
export DATA_UPLOAD_TAG="v0.1.0_a21d097"
export DATA_UPLOAD_TAG=$DATA_UPLOAD_TAG
export USER_PORTAL_TAG="v0.1.0_87e1099"
